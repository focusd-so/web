...
export function LoginForm({ callbackUrl }: LoginFormProps) {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Section - Logo and Testimonial */}
      <div className="flex-1 flex flex-col justify-between p-8 bg-muted">
        {/* Logo */}
        <div className="flex items-center">
          <img src="/logo_dark.png" alt="Focusd Work" className="h-20" />
        </div>

        {/* Testimonial */}
        <div className="max-w-md">
          <blockquote className="text-foreground text-lg leading-relaxed">
            "Focusd Work has transformed how I manage my time and productivity.
            The deep work sessions and distraction-free environment have helped
            me achieve more in less time."
          </blockquote>
        </div>
      </div>
